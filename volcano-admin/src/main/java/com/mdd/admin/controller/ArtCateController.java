...
import com.mdd.admin.service.system.artcate.IArtCateService;
...
public class ArtCateController {
    ...
    public AjaxResult<Object> del(@Validated @RequestBody IdValidate idValidate) {
        iArtCateService.del(idValidate.getId().longValue());
        return AjaxResult.success();
    }
    ...
    public AjaxResult<Object> change(@Validated @RequestBody IdValidate idValidate) {
        iArtCateService.change(idValidate.getId().longValue());
        return AjaxResult.success();
    }
