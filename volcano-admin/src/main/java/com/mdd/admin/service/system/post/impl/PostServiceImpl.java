package com.mdd.admin.service.system.post.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.core.toolkit.Assert;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.mdd.admin.service.system.post.IPostService;
...
public class PostServiceImpl implements IPostService {
    ...
    public void del(Long id) {
        ...
        UserBasic userBasic = systemAuthAdminMapper.selectOne(new QueryWrapper<UserBasic>()
                .select("id,nickname")
                .eq("post_id", id)
                .eq("is_delete", 0)
                .last("limit 1"));

        Assert.isNull(userBasic, "该岗位已被管理员使用,请先移除");
