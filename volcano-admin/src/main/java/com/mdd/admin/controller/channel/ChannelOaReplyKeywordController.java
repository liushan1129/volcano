...
public class ChannelOaReplyKeywordController {
     ...
     */
    @GetMapping("/detail")
    public AjaxResult<ChannelRpKeywordVo> detail(@Validated @IDMust() @RequestParam("id") Long id) {
    ...
    public AjaxResult<Object> del(@Validated @RequestBody IdValidate idValidate) {
        iChannelOaReplyKeywordService.del(idValidate.getId().longValue());
        return AjaxResult.success();
    }
    ...
    public AjaxResult<Object> status(@Validated @RequestBody IdValidate idValidate) {
        iChannelOaReplyKeywordService.status(idValidate.getId().longValue());
        return AjaxResult.success();
    }
