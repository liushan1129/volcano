...
public class ChannelOaReplyFollowController {
     ...
     */
    @GetMapping("/detail")
    public AjaxResult<ChannelRpFollowsVo> detail(@Validated @IDMust() @RequestParam("id") Long id) {
    ...
    public AjaxResult<Object> del(@Validated @RequestBody IdValidate idValidate) {
        iChannelOaReplyFollowService.del(idValidate.getId().longValue());
        return AjaxResult.success();
    }
    ...
    public AjaxResult<Object> status(@Validated @RequestBody IdValidate idValidate) {
        iChannelOaReplyFollowService.status(idValidate.getId().longValue());
        return AjaxResult.success();
    }
